  ...
  return (
    <View>
      ...
      <View style={styles.cardBottomText}>
        ...
        <Text style={styles.cdDateTime}>Aug 20, 0430h</Text>
        <Text style={styles.cdFlightNumberLabel}>Flight Number</Text>
        <Text style={styles.cdFlightNumber}>AB889</Text>
      </View>

      <View style={styles.cardTopText}>
        <Text style={styles.cdTitleEarth}>Earth</Text>
        <View style={styles.cdTitle}>
          <Text style={styles.cdSubTitleLeft}>Colombo</Text>
          <Text style={styles.cdSubTitleRight}>Olympus Mons</Text>
        </View>
        <Text style={styles.cdTitleMars}>Mars</Text>
        <Text style={styles.cdTime}>1d/{"\n"}23h</Text>
      </View>
